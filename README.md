...
fonts/            self-hosted woff2 (Syne, JetBrains Mono)
og.png            social-card image (generated by scripts/gen-og.mjs)
robots.txt        allow-all + sitemap pointer
sitemap.xml       single canonical URL
scripts/gen-og.mjs  regenerates og.png — borrows sharp via NODE_PATH=../til-blog/node_modules
CNAME             metzner.uk
